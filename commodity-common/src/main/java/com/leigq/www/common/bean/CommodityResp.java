package com.leigq.www.common.bean;
...
public class CommodityResp {
     ...
     * @return 响应对象
     */
    public CommodityResp success(String code, String msg, Object data) {
    	if (StringUtils.isBlank(code)) {
			code = CommodityResp.DEAFAULT_SUCCESS_CODE;
		}
    	if (StringUtils.isBlank(msg)) {
    		msg = CommodityResp.DEAFAULT_SUCCESS_MSG;
		}
	 ...
	 * @return 响应对象
	 */
	public CommodityResp success(String msg, Object data) {
		if (StringUtils.isBlank(msg)) {
			msg = CommodityResp.DEAFAULT_SUCCESS_MSG;
		}
		this.meta = new Meta(CommodityResp.DEAFAULT_SUCCESS_CODE, msg);
		this.data = data;
		return this;
	}
	 ...
	 * @return 响应对象
	 */
	public CommodityResp success(Object data) {
		this.meta = new Meta(CommodityResp.DEAFAULT_SUCCESS_CODE, CommodityResp.DEAFAULT_SUCCESS_MSG);
		this.data = data;
		return this;
	}
     ...
     * @return 响应对象
     */
    public CommodityResp failure(String code, String msg, Object data) {
    	if (StringUtils.isBlank(code)) {
			code = CommodityResp.DEAFAULT_FAILURE_CODE;
		}
    	if (StringUtils.isBlank(msg)) {
    		msg = CommodityResp.DEAFAULT_FAILURE_MSG;
		}
    	this.meta = new Meta(code, msg);
        this.data = data;
        return this;
	 ...
	 * @return 响应对象
	 */
	public CommodityResp failure(String msg, Object data) {
		if (StringUtils.isBlank(msg)) {
			msg = CommodityResp.DEAFAULT_FAILURE_MSG;
		}
